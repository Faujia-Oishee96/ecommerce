        ...
        <Container>
            {/*-------------------- Title part ---------------------*/}
                 ...
                 <div className='flex items-center gap-x-4'>
                    ...
                    <div><p className='text-primary font-primary font-semibold'>Categories</p></div>
                 </div>
                 {/*-------Second Title------*/}
                  <div className='pt-5'>
                 ...
                 {/*---------------- svg part -----------------*/}
                                ...
                                {/* slider start */}
                    {/* <div className='slider-container mt-[60px] flex flex-col gap-x-4'>
                        <Slider {...settings}>
                          <div className=' w-[170px] border border-black/30 rounded py-[25px] flex flex-col justify-center items-center'>
                          <div>
                              <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                         <g clip-path="url(#clip0_14023_430)">
                        ...
                        <line x1="15.1666" y1="39.8333" x2="40.8333" y2="39.8333" stroke="black" stroke-width="2"/>
                        </g>
                        <defs>
                        <clipPath id="clip0_14023_430">
                        <rect width="56" height="56" fill="white"/>
                          ...
                          <div>
                              <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_14023_953)">
...
<path d="M16.3334 46.6667H39.6667" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
<rect width="56" height="56" fill="white"/>
                        ...
                        <div className=' w-[170px] border border-black/30 rounded py-[25px] flex flex-col justify-center items-center'>
                          <div>
                            <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_14023_530)">
...
<rect width="56" height="56" fill="white"/>
                        ...
                        <div className=' w-[170px] border border-black/30 rounded py-[25px] flex flex-col justify-center items-center'>
                          <div>
                          <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_14023_2101)">
...
<rect width="56" height="56" fill="white"/>
                        ...
                        <div className=' w-[170px] border border-black/30 rounded py-[25px] flex flex-col justify-center items-center'>
                          <div>
                             <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_14023_544)">
<path d="M16.3333 30.3333H14C11.4227 30.3333 9.33331 32.4227 9.33331 35V42C9.33331 44.5773 11.4227 46.6666 14 46.6666H16.3333C18.9106 46.6666 21 44.5773 21 42V35C21 32.4227 18.9106 30.3333 16.3333 30.3333Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
<path d="M9.33331 35V28C9.33331 23.0493 11.3 18.3013 14.8007 14.8007C18.3013 11.3 23.0493 9.33331 28 9.33331C32.9507 9.33331 37.6986 11.3 41.1993 14.8007C44.7 18.3013 46.6666 23.0493 46.6666 28V35" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
<clipPath id="clip0_14023_544">
<rect width="56" height="56" fill="white"/>
</clipPath>
</defs>
</svg>
                        ...
                        <div className=' w-[170px] border border-black/30 rounded py-[25px] flex flex-col justify-center items-center'>
                          <div>
                          <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_14023_58)">
