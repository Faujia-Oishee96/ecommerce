                ...
                <div className='flex'>
                    {
                        check.map((item) => (
                            <div className='flex'>
                                <p className='font-primary text-base leading-[21px] text-secondary'>{item.title}</p>
                                <p className='text-secondary px-[12px]'>{item.p}</p>
                            </div>
                        ))
                    }
                    <p className='font-primary text-base leading-[21px]'>CheckOut</p>
                </div>
                <h2 className='font-secondary font-medium text-[30px] leading-[36px] pt-[80px] pb-[48px]'>Billing Details</h2>
                <div className='lg:flex justify-between'>
                    <div>
                        {
                            inputFields.map((field) => (
                                <div className='w-[470px] flex flex-col'>
                                    <label className='font-primary text-base leading-[24px] text-secondary mb-2'>{field.label}</label>
